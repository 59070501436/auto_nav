...
class lane_finder():
    ...
    def pipeline(self):
        ...
        # Getting ROI
        Roi = hsv[self.roi[1]:height,self.roi[0]:width-self.roi[0]] #-(roi_y+1),-(roi_x+1)
        ...
        ret, thresh = cv2.threshold(wscale, 128, 255, cv2.THRESH_BINARY) # thresholding the image //THRESH_BINARY_INV
